...
public sealed class IsaacCardPool : TypeListCardPoolModel
{
    ...
    public override string Title => "IsaacSpire";
    public override string EnergyColorName => "IsaacSpire";
    ...
    public override Color DeckEntryCardColor => IsaacCharacter.ThemeColor;

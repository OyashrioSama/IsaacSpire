...
namespace IsaacSpire.Characters;

[RegisterCharacter]
public sealed class IsaacCharacter : ModCharacterTemplate<IsaacCardPool, IsaacRelicPool, IsaacPotionPool>
{
    ...
    private const string CharacterScenePath = $"{SceneRoot}/Isaac_character.tscn";
    private const string EnergyCounterScenePath = $"{SceneRoot}/Isaac_energy_counter.tscn";
    private const string MerchantScenePath = $"{SceneRoot}/Isaac_merchant.tscn";
    private const string RestSiteScenePath = $"{SceneRoot}/Isaac_rest_site.tscn";
    private const string CharacterSelectBgScenePath = $"{SceneRoot}/Isaac_character_select_bg.tscn";
    ...
    public override CharacterAssetProfile AssetProfile => new(
        ...
        Ui: new CharacterUiAssetSet(
            // 人物头像路径。
            IconTexturePath: $"{ImageRoot}/Isaac_character_icon.png",
            // 人物头像轮廓。
            IconOutlineTexturePath: $"{ImageRoot}/Isaac_character_icon_outline.png",
            // 人物选择背景。
            CharacterSelectBgPath: CharacterSelectBgScenePath,
            // 人物选择图标。
            CharacterSelectIconPath: $"{ImageRoot}/Isaac_character_select.png",
            // 人物选择图标-锁定状态。
            CharacterSelectLockedIconPath: $"{ImageRoot}/Isaac_character_select_locked.png",
            // 地图上的角色标记图标、表情轮盘上的角色头像。
            MapMarkerPath: $"{ImageRoot}/Isaac_map_marker.png"));
